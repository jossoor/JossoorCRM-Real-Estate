...
class CRMLead(Document):
	...
	if TYPE_CHECKING:
		...
		from crm.fcrm.doctype.duplicate_lead_entry.duplicate_lead_entry import DuplicateLeadEntry
		from frappe.types import DF

		annual_revenue: DF.Currency
		annual_revenue_note: DF.Data | None
		assigned_to_display: DF.Text | None
		communication_status: DF.Link | None
		converted: DF.Check
		duplicate_leads: DF.Table[DuplicateLeadEntry]
		duplicated_from: DF.Link | None
		email: DF.Data | None
		...
		last_comment: DF.SmallText | None
